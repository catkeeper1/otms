package com.ckr.otms.exception.valueobject;
...
import com.ckr.otms.common.util.MessageResourceHolder;
...
public class ErrorResponse implements Serializable {
	...
	public void addMessage(String msgCode, Object[] params, HttpServletRequest request) {
		addMessage(msgCode,MessageResourceHolder.getMessage(msgCode, params, request) );
